...
def save_metrics_to_csv(metrics, logs, metrics_filename="./results/testing/FDFSAC_0_50.csv", logs_filename="info_logs.csv"):
...
dp_strategy = DifferentialPrivacyServerSideAdaptiveClipping(
    ...
    noise_multiplier=0,  # Adjusted for better privacy-utility trade-off
